...
int main (int argc, char** argv) {
    std::string fin = "/home/pang/data/dataset/multi_srereo/outdoor_day_calib/vi-sensor-stereo.yaml";

    std::string rectify_out_file = "/home/pang/data/dataset/multi_srereo/outdoor_day_calib/rectified_camera_parameters.txt";

    const std::string image0_path = "/home/pang/data/dataset/multi_srereo/outdoor_day1_data/image0_syn";
    const std::string image1_path = "/home/pang/data/dataset/multi_srereo/outdoor_day1_data/image1_syn";
...
//        cv::imshow("right_rect", right_rect);
        ...
        cv::Size resize(merge.cols, merge.rows);
        cv::Mat dst;
